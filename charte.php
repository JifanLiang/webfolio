...
<html>
	...
	<body>
			...
			<div id="charte1">
				...
				<div class="scroller">
					<div class="u-absolute u-fit-w u-pos-bl u-align-center is-active" has-binding="">
						<a href="#charte2" class="next"><div class="btn">+</div></a>
		...
		<div id="charte2" class="page wrap">
			<div class="bloc_text">
		...
		<div id="charte3" class="page wrap">
			...
			<div class="scroller">
				<a href="#charte4" class="next"><div class="btn">+</div></a>
			</div>
		</div>
		...
		<div id="charte5" class="page wrap">
			...
			<div class="scroller">
				<a href="#charte6" class="page next">
					<div class="btn">+</div>
				</a>
			</div>
		</div>
